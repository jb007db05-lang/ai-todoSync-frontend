          ...
          <button
            ...
            className={[
              ...
              filters.assigneeId === user.id
                ? "bg-olive-100 text-olive-700 dark:bg-olive-900/40 dark:text-olive-300 border border-olive-200 dark:border-olive-800"
                : "bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:border-olive-400"
            ].join(' ')}
          >
